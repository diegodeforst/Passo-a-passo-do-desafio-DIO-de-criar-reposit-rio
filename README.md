...
Escolha se esse repositório será ***"publico ou privado"***.<p>
  Clique em ***"Create repository"***<p>
    O próprio GitHub te dará os códigos para fazer no Git, sendo:
echo "# Curriculo_Site" >> README.md
git init
git add README.md
git commit -m "first commit"
git branch -M master
git remote add origin https://github.com/diegodeforst/Curriculo_Site.git
